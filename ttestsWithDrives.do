...
label var drivesCorr "Drive Words"
...
cibar drives, over1(can) over2(writer) over3(disc) barcol(ltblue erose ) blsize(tiny) graphopts(ytitle("Achievement + Power Words")legend(off))
...
mac drop _all
foreach x in WC posemo negemo drives Standout Grindstone Agentic Communal {
