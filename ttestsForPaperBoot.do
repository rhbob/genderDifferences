cap drop _all
import excel "/Users/rhbob/Desktop/genderAnalysis/stata/annotated_v6_drives.xlsx", sheet("annotated_v6_drives") firstrow clear
...
label var Ability "Ability Words"
gen sorter=_n
...
foreach x in WC posemo negemo achieve Standout Grindstone Agentic Communal Ability{
	...
	bootstrap t=r(t), reps(1000) nodots nowarn bca: ttest `x' if discipline==0 & writer==0,by(can)
    bootstrap diff=(r(mu_1) - r(mu_2)), reps(1000) nodots nowarn bca: ttest `x' if discipline==0 & writer==0, by(can)
   ...
   bootstrap diff=(r(mu_1) - r(mu_2)), reps(1000) nodots nowarn bca: ttest `x' if discipline==0 & writer==1, by(can)
    bootstrap t=r(t), reps(1000) nodots nowarn bca: ttest `x' if discipline==0 & writer==1,by(can)
	...
	bootstrap t=r(t), reps(1000) nodots nowarn bca : ttest `x' if discipline==1 & writer==0,by(can)
	bootstrap diff=(r(mu_1) - r(mu_2)), reps(1000) nodots nowarn bca: ttest `x' if discipline==1 & writer==0, by(can)	
	...
	bootstrap t=r(t), reps(1000) nodots nowarn bca: ttest `x' if discipline==1 & writer==1,by(can)
	bootstrap diff=(r(mu_1) - r(mu_2)), reps(1000) nodots nowarn bca: ttest `x' if discipline==1 & writer==1, by(can)	
