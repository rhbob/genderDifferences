...
// and then replace getMean in plots by getMedian
...

{
  ...
  for (Int_t ithLetter = 0 ; ithLetter< letterLength; ++ithLetter){
	...
	Apostro <<  " "  << Parent <<  " "  << OtherP  << " " << ranking << " " << negative << "\n \n " <<  std::endl;
    }
 ...
 analysisOut <<    static_cast<Float_t>(drivescMrMphysics->GetMean()) << " " << 
  ...
  xaxisDrivesPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisDrivesPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  Float_t y2[4] = {
    static_cast<Float_t>(drivescMrMsocsci->GetMean() - 0.12),
    static_cast<Float_t>(drivescFrMsocsci->GetMean() - 0.31),
    static_cast<Float_t>(drivescFrFsocsci->GetMean() - 0.38),
    static_cast<Float_t>(drivescMrFsocsci->GetMean() - 0.25)
  };
  ...
  xaxisDrivesSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisDrivesSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisAffectPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisAffectPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxisAffectSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisAffectSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxisSocialPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisSocialPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxisSocialSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisSocialSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxistimeOrientFuturePhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxistimeOrientFuturePhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxistimeOrientFutureSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxistimeOrientFutureSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxisworkPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisworkPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxisworkSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisworkSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  //another of Jamie's summary variables, don't use
  ...
  xaxisanalyticPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisanalyticPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxisanalyticSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxisanalyticSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  // analytic variable, from PDF created by Jamie, not usable
  ...
  xaxiscloutPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxiscloutPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxiscloutSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxiscloutSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  //super-correlated with field of study
  ...
  xaxishomePhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxishomePhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxishomeSocsci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"cFrF");
  xaxishomeSocsci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"cMrF");
  ...
  xaxisPosemoPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisPosemoPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisPosemoSocSci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisPosemoSocSci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisNegemoPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisNegemoPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisNegemoSocSci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisNegemoSocSci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
