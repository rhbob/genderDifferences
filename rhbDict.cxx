...

{
  ...
  TNtuple* physics = new TNtuple("physics","Physics Ntuple",
				 "cat:wc:WPS:Dic:standout:ability:grindstone:teaching:research:agentic:communal:internal1:internal2:internal3:internal4:internal5:internal6");
  ...
  for (Int_t ithLetter = 0 ; ithLetter< letterLength; ++ithLetter)
    {
      inputFiles >> rowNo >> rowHash >> bobHash >> canGender >> writerGender >> both >> discipline
 ...
 Double_t par0;
  ...
  xaxisWordCountsPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisWordCountsPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisWordCountsSocSci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisWordCountsSocSci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  analysisOut <<  static_cast<Float_t>(standoutPhysicscMrM->GetMean()) << " " << 
    ...
    static_cast<Float_t>(standoutPhysicscMrF->GetMean()) << " " << std::endl;
  ...
  analysisOut <<    static_cast<Float_t>(grindstonePhysicscMrM->GetMean()) << " " << 
    ...
    static_cast<Float_t>(grindstonePhysicscMrF->GetMean()) << " " << std::endl;
 ...
 c2->cd(1);
  ...
  standoutPhysics->SetTitle("HEP Standout");
  ...
  xaxisStandoutPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisStandoutPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisStandoutSocSci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisStandoutSocSci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  grindstonePhysics->SetTitle("HEP Grindstone");
  ...
  xaxisGrindstonePhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisGrindstonePhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisGrindstoneSocSci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisGrindstoneSocSci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  agenticPhysics->SetTitle("HEP Agentic");
  ...
  xaxisAgenticPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisAgenticPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisAgenticSocSci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisAgenticSocSci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxisCommunalPhysics->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisCommunalPhysics->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  //
  c7->cd(2); //TCanvas* c8 = new TCanvas();
  ...
  xaxisCommunalSocSci->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxisCommunalSocSci->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxis11->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxis11->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
  ...
  xaxis12->ChangeLabel(5,-1.,-1.,-1,-1,-1,"#splitline{cand. F}{writer F}");
  xaxis12->ChangeLabel(7,-1.,-1.,-1,-1,-1,"#splitline{cand. M}{writer F}");
